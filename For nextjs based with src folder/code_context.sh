...
directories=("src" "components" "pages" "app" "api" "styles" "utils" "hooks" "constants" "services" "types" "libs" "lib" "middleware" "store" "context" "providers")
...
root_files=("package.json" "next.config.js" "next.config.mjs" "next.config.ts" "tsconfig.json" "jsconfig.json" "tailwind.config.js" "tailwind.config.ts" "postcss.config.js" ".env" ".env.local" ".env.example" "README.md" "Dockerfile" ".gitignore" ".eslintrc.json" ".prettierrc" "vercel.json")
